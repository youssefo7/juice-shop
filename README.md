...
[![pre-commit](https://sonarcloud.io/api/project_badges/measure?project=youssefo7_juice-shop&metric=coverage)](https://github.com/pre-commit/pre-commit)
...
5. Run `npm start`
6. TEST Browse to <http://localhost:3000>
